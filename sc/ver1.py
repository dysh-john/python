...
ask_continue = "y"
while ask_continue == "Y" or ask_continue == "y":
    sleep(1)
    ...
    sleep(3)
    print("")
    ask_continue = input("Do you want to continue to use the program? (Y/y)")
    if ask_continue == "Y" or ask_continue == "y":
        "After 3 seconds start new scarping...."
        sleep(3)
        print("")
        print("----- Start new scraping -----")
    else:
        exit()
